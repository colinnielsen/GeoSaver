...
const PageHeader = (props) => (
    <Segment clearing>
        <Header as='h3' onClick={props.dashboardRedirect} floated='right' id="tagline">
            Save your photos!
            {props.loggedIn ? <button className="ui button negative" onClick={props.logout}>Logout</button> : <button className="ui button" onClick={props.loginButton}>Login</button>}
        </Header>
